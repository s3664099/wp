...
var quantity = 0;
var getPrice = document.getElementById("soft"); 
var initPrice = getPrice.textContent;
var price = Number(initPrice);
var quant = 0;
const basePrice=10;
var error = false;
var message = "";
...
function soft(){
    var str = document.getElementById("soft");
    var opt = str.textContent;
    price = Number(opt);
    displayPrice();
}

function hard() {
    var str = document.getElementById("hard");
    var opt = str.textContent;
    price = Number(opt);
    displayPrice();
}
...
function audio() {
    var str = document.getElementById("audio");
    var opt = str.textContent;
    price = Number(opt);
    displayPrice();
}
...
function graphic() {
    var str = document.getElementById("graphic");
    var opt = str.textContent;
    price = Number(opt);
    displayPrice();
}
